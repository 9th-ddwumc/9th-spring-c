...
import com.example.umc9th2.global.apiPayload.code.PageErrorCode;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<String>> handleException(Exception ex) {
        ...
        BaseErrorCode code = GeneralErrorCode.INTERNAL_ERROR;
    ...
    public ApiResponse<?> handleIllegalArgument(IllegalArgumentException e) {
        return ApiResponse.onFailure(PageErrorCode.INVALID_PAGE, null);
    }
}
